...
- Name: portals_ui.spec.js >> Vue 3 Portals UI E2E >> Employee Self-Service Portal Routing & Rendering
- Location: tests/portals_ui.spec.js:5:3
...
Expected substring: "My Tickets"
Received string:    "IT Helpdesk"
Timeout: 5000ms

Call log:
  - Expect "toContainText" with timeout 5000ms
  - waiting for locator('h1').first()
    14 × locator resolved to <h1 class="text-xl font-bold">IT Helpdesk</h1>
       - unexpected value "IT Helpdesk"

```

```yaml
- heading "IT Helpdesk" [level=1]
```
